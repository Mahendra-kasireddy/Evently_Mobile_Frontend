...
export const EventlyTextInput = forwardRef<TextInput, EventlyTextInputProps>(
  function EventlyTextInputInner({ style, ...rest }, ref) {
    return (
      <TextInput
        ref={ref}
        style={[eventlyTextInputStyles.base, style]}
